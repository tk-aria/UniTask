...
namespace Cysharp.Threading.Tasks
{
    public partial struct UniTask
    {
      ...
      /// <summary>Run action on the main thread.</summary>
        ...
        /// <summary>Run action on the main thread.</summary>
        public static async UniTask RunOnMainThread(Action<object> action, object state, bool configureAwait = true, CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        /// <summary>Run action on the main thread.</summary>
        public static async UniTask RunOnMainThread(Func<UniTask> action, bool configureAwait = true, CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        /// <summary>Run action on the main thread.</summary>
        public static async UniTask RunOnMainThread(Func<object, UniTask> action, object state, bool configureAwait = true, CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        /// <summary>Run action on the main thread.</summary>
        public static async UniTask<T> RunOnMainThread<T>(Func<T> func, bool configureAwait = true, CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        /// <summary>Run action on the main thread.</summary>
        public static async UniTask<T> RunOnMainThread<T>(Func<UniTask<T>> func, bool configureAwait = true, CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        /// <summary>Run action on the main thread.</summary>
        public static async UniTask<T> RunOnMainThread<T>(Func<object, T> func, object state, bool configureAwait = true, CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        /// <summary>Run action on the main thread.</summary>
        public static async UniTask<T> RunOnMainThread<T>(Func<object, UniTask<T>> func, object state, bool configureAwait = true, CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
